...
function App() {
	...
	const videosJune24: Slide[] = [
		{ id: 1, url: './videos/2024/06/03/IMG_0587.MOV', caption: 'Our First Time Cooking Breakfast Together', date: '2024-06-03' },
		{ id: 2, url: './videos/2024/06/22/IMG_0859.MOV', caption: 'Our First Time At The Scenic Overlook', date: '2024-06-22' },
		{ id: 3, url: './videos/2024/06/23/IMG_0863.MOV', caption: 'Our First Time At Bluestone Lake', date: '2024-06-23' },
		{ id: 4, url: './videos/2024/06/29/IMG_0929.MOV', caption: 'Our First Time At Pinnacle Rock', date: '2024-06-29' },
	];

	const videosAugust24: Slide = { 
		id: 1, 
		url: './videos/2024/08/25/IMG_1253.MOV', 
		caption: 'A Beautiful Voice is Heard',
		date: '2024-08-25'
	};

	const videosOctober24: Slide[] = [
		{ id: 1, url: './videos/2024/10/27/IMG_3761.MOV', caption: 'Our Family Gains a New Member', date: '2024-10-27' },
		{ id: 2, url: './videos/2024/10/30/IMG_1385.MOV', caption: 'The New Siblings Adjust', date: '2024-10-30' },
	];
...
const imagesDecember25: Slide[] = [
	{
		id: 1,
		url: "./images/2025/12/12/IMG_8498.jpeg",
		caption: "The World's Most Comfortable Pillow",
		date: "December 12, 2025"
	},
	{
		id: 2,
		url: "./images/2025/12/17/IMG_8495.jpeg",
		caption: "Smiles Warm Enough to Melt the Cold Away",
		date: "December 17, 2025"
	},
	{
		id: 3,
		url: "./images/2025/12/17/IMG_8497.jpeg",
		caption: "Curled Up in Each Other's Arms",
		date: "December 17, 2025"
	},
	{
		id: 4,
		url: "./images/2025/12/17/IMG_8500.jpeg",
		caption: "Being Silly Together is Fun",
		date: "December 17, 2025"
	},
];
...
const videosFebruary26: Slide = {
	id: 1,
	url: "./videos/2026/02/14/IMG_2015.mov",
	caption: "An Adorable Valentine's Day With Slimes",
  ...
  return (
	<>
		...
		<div className="slide-container">
			<h2 className="slide-month">Keeping Each Other Warm in December</h2>
			<Slide autoplay={true} pauseOnHover={true} easing="ease-in" duration={5000} transitionDuration={1500} indicators={true} infinite={true} arrows={false}>
				{imagesDecember25.map((slideImage) => (
					<div key={slideImage.id} className="each-slide">
						<span className="slide-caption">{slideImage.caption}<br />{slideImage.date}</span>
						<img
							className="slide-image"
		...
		<div className="slide-container-alt">
			<h2 className="slide-month-alt">A Unforgettable Valentine's Day</h2>
			<div key={videosFebruary26.id} className="each-slide">
				<span className="slide-caption-alt">{videosFebruary26.caption}<br />{videosFebruary26.date}</span>
				<video 
					className="slide-image-alt"
					src={videosFebruary26.url}
					controls
				/>
			</div>
		</div>
